...
<div class="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-96 text-center">
        ...
        <p class="mb-6 text-gray-800">Customize your experience</p>
        ...
        <button class="mt-6 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700" onclick={close}>Close</button>
    </div>
</div>